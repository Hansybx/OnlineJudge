...
from ..views.oj import (ApplyResetPasswordAPI, ResetPasswordAPI,
                        ...
                        ProfileProblemDisplayIDRefreshAPI, OpenAPIAppkeyAPI, SSOAPI, UserChangeClassNumAPI)
...
urlpatterns = [
    ...
    url(r"^change_class_num/?$", UserChangeClassNumAPI.as_view(), name="user_change_class_num_api"),
]
